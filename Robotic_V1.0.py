...
def main():
    ...
    cap = VideoCapture('http://10.27.46.129:8080/video') #'0' is default port for built-in webcam camera, yours might be different


    coor_input = ['Up','Down','Left','Right','Forward','Backward']
    orien_input = ['TUp','TDown','TLeft','TRight']
    theta1 = 0
    theta2 = 110
    theta3 = -90
    theta4 = 0
    ...
    while cameraOn:
        ...
        while user_input:
            ...
            #Adjusting orientation
                ...
                if key == 'TUp': #tilt up
                    theta[3] += 5
                elif key == 'TDown': #tilt down
                    theta[3] -= 5
                elif key == 'TLeft': #tilt left
                    theta[4] -= 5
                elif key == 'TRight': #tilt right
                    theta[4] += 5
